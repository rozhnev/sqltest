...
class Router 
{
    ...
    private $routes = [
        ...
        'static-page'       => "@(?<lang>ru|en|pt|fr)/(?<action>privacy-policy|user-agreement|logout|about|menu|books|courses|donate)/?@i",
        ...
        'user'              => "@(?<lang>ru|en|pt|fr)/(?<class>user)/(?<action>achievements|profile|update|submission-requirements|send-email-verification-code|confirm-email-verification-code)@i",
        'user_task_submissions' => "@(?<lang>ru|en|pt|fr)/(?<class>user)/(?<action>task-submissions|task-submission-create)/?@i",
        'user_task_submission' => "@(?<lang>ru|en|pt|fr)/(?<class>user)/(?<submissionID>\d+)/(?<action>task-submission-update|task-submission-delete)/?@i",
