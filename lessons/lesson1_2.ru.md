...
teaches: ["Основные типы баз данных и их отличия", "Когда использовать реляционные, а когда NoSQL базы данных", "Модели ключ-значение, документные, графовые и колоночные БД", "Чем реляционные БД отличаются от других типов", "Как выбрать подходящий тип базы данных для задачи"]
about: ["Реляционная база данных", "NoSQL", "Ключ-значение", "Документная база данных", "Графовая база данных", "Временные ряды", "Колоночная база данных"]
---
