...
_Урок 6.2 · _Время чтения: ~8 минут_
...
<img src="/images/lessons/lesson6_2-where-subqueries.svg" alt="Схема подзапросов в WHERE с операторами IN, EXISTS, ANY и ALL" width="100%">
