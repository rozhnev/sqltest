...
Например, таблица `customers` может одновременно использовать несколько ограничений:
...
СУБД автоматически отклонит любой `INSERT` или `UPDATE`, нарушающий эти правила, обеспечивая корректность данных без дополнительной логики в приложении.
