...
_Урок 6.1 · Время чтения: ~7 минут_
...
<img src="/images/lessons/lesson6_1-subqueries-intro.svg" alt="Схема подзапросов SQL: выполнение внутреннего запроса, затем внешнего, и варианты использования в SELECT, WHERE и FROM" width="100%">
