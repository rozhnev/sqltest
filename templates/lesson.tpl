        ...
        <main3 id="main3">
            ...
            <div class="column">
                ...
                <div class="code-buttons">
                    <div id="prevTaskBtn">
                        <a class="button hidden" href="/{$Lang}/lesson/{$NextLesson.moduleSlug}/{$NextLesson.slug}}" title="{translate}next_lesson{/translate}">
                    ...
                    <div id="nextTaskBtn">
                        <a class="button green hidden" href="/{$Lang}/lesson/{$NextLesson.moduleSlug}/{$NextLesson.slug}}" title="{translate}next_lesson{/translate}">
