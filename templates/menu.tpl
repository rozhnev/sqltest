        ...
        <div id="menu-content" class="menu-content">
            {if $User->logged()}
                ...
                <div class="panel {if isset($QuestionCategoryID) && 99 eq $QuestionCategoryID}active{/if}">
                    ...
                    <li>
                        <a class="question-link {if  isset($QuestionID) && $QuestionID == $question[1]} current-question{/if}{if $question[2]} solved{/if}" href="/{$Lang}/question/favorites/{$question[3]}">
