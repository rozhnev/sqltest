...
<!DOCTYPE html>
    <html xmlns="http://www.w3.org/1999/xhtml" lang="{$Lang}">
        <head>
            ...
            <meta http-equiv="Content-Security-Policy" content="frame-src 'self' mc.yandex.md mc.yandex.ru yandex.ru passport.yandex.ru oauth.yandex.ru yango.com passport.yango.com oauth.yango.com mc.yandex.com *.yastatic.net yastatic.net;">
