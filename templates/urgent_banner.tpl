<div id="urgent-banner" style="background:#bf1303; color:#fff; padding:0.75rem 1.5rem; text-align:center; display:flex; align-items:center; justify-content:center; gap:0.75rem; flex-wrap:wrap;">
