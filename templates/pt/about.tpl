...
<article class="about">
    <div class="section top colored">
        <div>
            ...
            <h2>Seu laboratório pessoal para aprender e dominar SQL!</h2>
        </div>
    </div>
    <div class="section not-colored">
        <div>
            <div class="section-column" style="padding: 0 0 0 2rem; white-space: nowrap;">
                <b>Sobre a equipe e nossos padroes de qualidade</b>
            </div>
            <div class="section-column" style="max-width: 50rem;">
                <p><strong>SQLTest.online e um treinador online gratuito para aprender e praticar SQL.</strong> A plataforma oferece tarefas interativas em bancos de dados reais, permite acompanhar o progresso de aprendizado e se preparar para entrevistas tecnicas. O site e criado por especialistas que trabalham diariamente com dados: instrutores de SQL, analistas de dados e desenvolvedores backend com experiencia em otimizacao de consultas e modelagem de esquemas de banco de dados.</p>
                <p>Criamos a plataforma para tornar o treinamento pratico em SQL acessivel, realista e mensuravel. Hoje, a biblioteca inclui <strong>398+ tarefas praticas</strong> para ajudar alunos a evoluir da sintaxe basica para resolucao de problemas em cenarios de producao.</p>
                <p><strong>Como construimos cada tarefa:</strong></p>
                <ul>
                    <li><strong>Contexto do mundo real</strong><br>Os cenarios sao inspirados em fluxos reais de analise, relatorios e desenvolvimento de aplicacoes.</li>
                    <li><strong>Validacao em multiplos mecanismos</strong><br>As consultas sao verificadas em motores reais usados na industria (por exemplo MySQL, PostgreSQL, MS SQL Server e Firebird).</li>
                    <li><strong>Dificuldade progressiva</strong><br>As trilhas evoluem dos fundamentos para topicos avancados, como joins, window functions e escrita de consultas com foco em performance.</li>
                    <li><strong>Ciclo continuo de revisao</strong><br>Monitoramos feedback dos usuarios e atualizamos tarefas, respostas esperadas e explicacoes para manter o conteudo correto.</li>
                </ul>
                <p><strong>Perfis publicos e identidade do projeto:</strong></p>
                <ul>
                    <li><strong>LinkedIn</strong>: <a href="https://www.linkedin.com/company/sqltest/" target="_blank" rel="noopener">SQLTest no LinkedIn</a></li>
                    <li><strong>GitHub</strong>: <a href="https://github.com/rozhnev/sqltest" target="_blank" rel="noopener">Repositorio de codigo do SQLTest</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="section">
        <div>
            <div class="color-block" style="background-color: #E5F7EB;">
                <img src="/images/about-for-students.png" alt="Aprendizado de SQL para estudantes no SQLTest.online" style="width: 90%;">
                <div>
                    <div>
                        <b>Quer aprender Structured Query Language</b><br>para trabalhar com dados com confiança?
                    </div>
            ...
            <div class="color-block" style="background-color: #FEF5F5;">
                <img src="/images/about-for-devs.png" alt="Pratica de SQL para desenvolvedores e analistas" style="width: 90%;">
                <div>
                    <div>
                        <b>Ou talvez você seja um desenvolvedor experiente</b><br>procurando expandir seu conhecimento e se preparar para entrevistas técnicas difíceis?
                    </div>
                    <div class="fake-button">
                        Sim, sou eu!
                    </div>
    ...
    <div class="section colored">
        <div class="blue-block"> 
            <h2>SQLTest.online é o lugar perfeito para você!</h2>
            <a href="/pt/" class="button white">
                Comece a treinar&nbsp;→
            </a>
        </div>
    </div>
    <div class="section not-colored">
        <div>
            <div class="section-column" style="padding: 0 0 0 2rem; white-space: nowrap;">
                <b>O que você vai ganhar?</b>
            </div>
            <div class="section-column">
                <ul>
                    <li><b>Conhecimento sólido de SQL</b><br> Entenda os fundamentos da linguagem e aprenda a escrever consultas eficientes.</li>
    ...
    <div class="section not-colored">
        <div style="width: 100%;"><b>Para quem é o SQLTest.online?</b></div>
        <div>
    ...
    <div class="section not-colored">
        <div style="width: 100%;"><b>Como começar?</b></div>
        <div>
            <div style="display: flex; flex-flow: row wrap; justify-content: space-between; gap: 1rem;">
    ...
    <div class="section not-colored">
        <div>
            ...
            <div class="section-column" style="max-width: 50rem;">
                <ul>
                    <li><strong>Aprendizado interativo</strong><br>Resolva várias tarefas de SQL diretamente no navegador. Não há necessidade de instalar programas adicionais ou configurar um ambiente.</li>
                    <li><strong>Variedade de bancos de dados</strong><br>Pratique em bancos de dados populares como MySQL, PostgreSQL, MS SQL Server e Firebird.</li>
                    <li><strong>Atualizações constantes</strong><br>Adicionamos novas tarefas regularmente para que você sempre encontre desafios interessantes.</li>
                    <li><strong>Estatísticas detalhadas</strong><br>Acompanhe seu progresso, analise erros e melhore seus resultados.</li>
                    <li><strong>Comunidade</strong><br>Interaja com outros usuários, compartilhe experiências e obtenha ajuda.</li>
                </ul>
            </div>
        </div>  
    </div>
    ...
    <div class="section colored">
        <div class="blue-block"> 
            <h4>Todos interessados em programação</h4>
            <h2>Expanda seus horizontes e aprenda um novo idioma.</h2>
    ...
    <div class="section not-colored">
        <div style="width: 100%;">
            ...
            <h2>Siga nossas notícias nas redes sociais</h2>
            <h4>e assine nossa newsletter para se manter atualizado com as últimas notícias.</h4>
            </div>
            <div class="section-column column30" style="display: flex; flex-flow: row wrap; justify-content: space-around;">
                <a href="https://telegram.me/sqlize" target="_blank"class="social-media-link">
                    <div>
                        <img src="/images/telegram_logo.png" alt="Logo do Telegram">
                        Telegram
                    </div>
                </a>
                <a href="https://www.linkedin.com/company/sqltest/" target="_blank"class="social-media-link">
                    <div>
                        <img src="/images/linkedin_logo.png" alt="Logo do LinkedIn">
                        Linkedin
                    </div>
                </a>
            </div>
