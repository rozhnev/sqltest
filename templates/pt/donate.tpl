    ...
    <div class="section" style="height: 100%;">
        <div style="display: block;">      
            ...
            <div class="donation-methods">
                ...
                <div class="donation-method">
                    <h3>Apoie em qualquer moeda</h3>
                    <p>Doação ou assinatura no Boosty:</p>
                    <p>
                        <a href="https://boosty.to/phpize/donate" target="_blank" style="background-color: white; display: flex; padding: 12px; margin: 1rem auto; border-radius: 6px; width: 10rem;">
                            <svg width="145px" height="40px" alt="Doação ou assinatura no Boosty" viewBox="0 0 145 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <defs>
                        ...
                        alt="Doação ou assinatura no Boosty"
                        style="width: 200px;
