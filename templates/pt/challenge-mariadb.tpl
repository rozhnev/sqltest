...
<section class="mariadb-highlight">
    <div>
        <h2>O que esperar do MariaDB Day Brussels</h2>
        <p>
...
<section class="mariadb-grid">
    ...
    <article>
        <h3>Porque participar no FOSDEM</h3>
        <p>
