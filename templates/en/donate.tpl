        ...
        <div style="display: block;">      
            ...
            <div class="donation-methods">
                ...
                <div class="donation-method">
                    ...
                    <p>
                        <a href="https://boosty.to/phpize/donate" target="_blank" style="background-color: white; display: flex; padding: 12px; margin: 1rem auto; border-radius: 6px; width: 10rem;">
                            <svg width="145px" height="40px" alt="Donate or subsription on Boosty" viewBox="0 0 145 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <defs>
                ...
                <div class="donation-method">
                    ...
                    <p>Support us using USDT on the TRON network  (USDT TRC20):</p>
                    ...
                    <p class="warning-text">
                        Important!<br>
                        Send USDT only to TRC20 address. Sending in any other blockchain may result in permanent loss of funds.
                    </p>
                </div>
            </div>
        </div>
