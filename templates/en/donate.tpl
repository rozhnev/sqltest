    ...
    <div class="section" style="height: 100%;">
        <div style="display: block;">      
            ...
            <div class="donation-methods">
                ...
                <div class="donation-method">
                    <h3>Lava.top (EUR/USD payments)</h3>
                    <p>Prefer paying in euros? Lava.top accepts cards issued by Russian banks, PayPal, and several other payment methods.</p>
                    ...
                    <p class="donation-fallback">If the widget does not load, use the direct link: <a href="https://app.lava.top/products/2800c402-a8c3-404e-8e75-940937b813f9/e2ee84c7-d8e7-4521-98dc-cc336c001a45?currency=EUR&domainId=77569739-54ac-45a4-9efc-9c6fc8b454aa&domainName=sqltest.online" target="_blank" rel="noopener noreferrer">lava.top</a>.</p>
                </div>
                <div class="donation-method">
