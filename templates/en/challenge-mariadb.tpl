...
<section class="mariadb-highlight">
    <div>
        ...
        <p>
            MariaDB Day Brussels is a full-day community gathering that brings maintainers,
            contributors, partners, and users together to show the present and future of MariaDB.
    ...
    <div class="floating-card">
        ...
        <p>
            Anna Widenius, Sergei Golubchik, Steve Shaw, Jan Lindström, Paul Clevett, Nick Denning,
            Alejandro Duarte, Dirk Hillbrecht, Andrija Vučinić, Carl Schwan, Roman Agabekov, and more.
        </p>
        <p>
            Topics include Meet 12.3 LTS, OLTP throughput in Enterprise Server 11.8, MariaDB is the Future of MySQL,
            extending MariaDB with the plugin API, deploying RAG without the plumbing, architectural AI advantages,
            safer automation, and (almost) no downtime upgrades.
        </p>
    </div>
</section>
