<div class="welcome-container">
    ...
    <section>
        <h3>Support</h3>
        <p>If you need help, have feedback, or want to report an issue, email us at <a style="color: #8A5000; text-decoration: underline;" href="mailto:support@sqltest.online">support@sqltest.online</a>.</p>
    </section>
</div>