    ...
    <body>
        <div class="{if $MobileView}mobile-container{else}full-container{/if}">
            ...
            <div class="container3">
                ...
                <h2>What's New:</h2>
                <p>Currently, we have over 20 tasks based on the Sakila database from MySQL. We regularly add new tasks and aim to expand the number of databases to provide you with a broader learning experience.</p></details>
