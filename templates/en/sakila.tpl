<div id="db-description" class="db-description">
    ...
    <p>
        <a href="/{$Lang}/erd/Sakila" target="ERDWindow" rel="noopener noreferrer" style="display: flex; flex-direction: column; align-items: center; gap: 4px;" aria-label="Open Sakila database ER diagram in a new window">
            <img src="/images/erd_small_light.svg" alt="ER diagram of the Sakila database showing table relationships" width="1080" height="360" style="width: 90%; height: auto;" loading="lazy" decoding="async">
    ...
    {if $User->showAd()}
        <div class="referal-add-block">
            <div style="box-sizing: border-box; width: 100%; max-width: 760px; padding: 1.25rem 1.5rem; border: 1px solid #f0c36a; border-radius: 8px; background: linear-gradient(135deg, #fff8e7 0%, #fffdf8 58%, #eaf6f3 100%); color: #243238; text-align: center;">
                <a href="https://www.pythonforbeginners.org/?ref=sqltest.online" target="_blank" rel="noopener noreferrer" style="display: block; color: #243238; text-decoration: none;">
                ...
                <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 0.7rem; margin-top: 1rem;">
                    <a href="https://www.pythonforbeginners.org/?ref=sqltest.online" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0.6rem 1rem; border-radius: 5px; background: #176b5d; color: #fff; font-weight: 700; text-decoration: none;">Start learning</a>
                    <a href="https://www.amazon.com/dp/B0HC46YNP6?ref=sqltest.online" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 0.6rem 1rem; border: 1px solid #176b5d; border-radius: 5px; color: #176b5d; font-weight: 700; text-decoration: none;">Get the book</a>
                </div>
            </div>
        </div>
    {/if}
