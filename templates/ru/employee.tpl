<div id="db-description" class="db-description">
    ...
    {if $add_id > 2}
        <a href="https://book24.ru/r/RaSLq?erid=LjN8KWDe6" target="_blank" style="text-decoration: none;">
    ...
    {else}
      <div style="display: flex; flex-direction: row; gap:5px; border: 1px solid white; padding: 0.3em; width: 98%;">
        <!-- admitad.banner: sggtutr216fec845fb2faf541d880b Hexlet.io -->
        ...
        <!-- /admitad.banner -->
        <!-- admitad.banner: fiu7it8s2hfec845fb2f3b8a152381 Karpov.courses -->
