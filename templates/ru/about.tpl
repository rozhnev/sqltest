<div class="db-description">
    ...
    <h2>Что нового:</h2>
    <details><summary></summary>
    <p>На данный момент у нас более 20 задач, представленных на базе данных Sakila от MySQL. Мы регулярно добавляем новые задания и стремимся расширить количество баз данных, чтобы предоставить вам более широкий опыт.</p></details>
