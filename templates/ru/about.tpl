    ...
    <body>
        <div class="{if $MobileView}mobile-container{else}full-container{/if}">
            ...
            <div class="container3">
                ...
                <h2>Что нового:</h2>
                <p>На данный момент на нашем сайте представлено более {floor(($QuestionsCount - 1)/10) * 10} задач различной сложности в {$CategoriesCount} категориях , на базе данных Sakila (MySQL) и EMPLOEE (Firebird). Мы регулярно добавляем новые задания и стремимся расширить количество баз данных, чтобы предоставить вам более широкий опыт.</p></details>
