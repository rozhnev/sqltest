...
<p>Таблица `film`</p>
  <ul class="table-columns">
    ...
    <li> `language_id` - внешний ключ, ссылающийся на языковую таблицу.</li>
    <li> `original_language_id` - внешний ключ, ссылающийся на языковую таблицу.</li>
    <li> `rental_duration` - продолжительность аренды в днях.</li>
    <li> `rental_rate` – ставка аренды.</li>
    <li> `length` - продолжительность фильма в минутах.</li>
    <li> `replacement_cost` - стоимость замены.</li>
    <li> `rating` - рейтинг фильма.</li>
    <li> `special_features` - особенности фильма.</li>
    <li> `last_update` - временная метка, последнего изменения записи.</li> 
  </ul>
  <div class="table-wrapper">
    <table>
...
<p>Таблица `customer`</p>
  ...
  <ul class="table-columns">
    ...
    <li> `address` – дополнительный адрес.</li>
...
<p>Таблица `payment`</p>
<ul class="table-columns">
<li> `pay_id` – уникальный идентификатор для каждого платежа.</li>
