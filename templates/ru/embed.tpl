...
<p><em>Примечание: также доступны предустановленные наборы данных, такие как <code>mysql80_sakila</code>, <code>mariadb118_openflights</code> и <code>psql10demo</code>.</em></p>
...
<p>SQLize Embed распространяется на основе <strong>платной подписки</strong>.</p>

<ul>
    <li><strong>Лицензирование по доменам</strong>: Подписка требуется для каждого домена верхнего уровня, на котором размещен скрипт.</li>
    <li><strong>Цена по запросу</strong>: Мы предлагаем гибкое ценообразование в зависимости от вашего трафика и требований к использованию.</li>
</ul>

<p>Для получения индивидуального предложения и лицензионного ключа, пожалуйста, свяжитесь с нами по адресу <a href="mailto:support@sqlize.com">support@sqlize.com</a>.</p>
