<div class="menu" id="menu">
    ...
    <div style="height: 6em;">
        ...
        <p style="padding: 5px; font-size:12px;">
            Доходы от рекламы и пожертвования являются нашими единственными источниками финансирования. Пожалуйста, не отключайте рекламу или внесите <a href='/ru/donate'>посильное пожертвование</a>.<br>
