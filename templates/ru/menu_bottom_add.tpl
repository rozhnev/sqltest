        ...
        <div class="menu-ad">
            <div id="yandex_rtb_R-A-4716552-2">
                ...
                <div style="
                    ...
                    border-radius: 0 6px 0 0;
                    padding: 0.5em;
                    color: white;">🎉 Друзья! Рады представить вам наш новый образовательный проект – открытый онлайн-учебник по SQL!</div>
                    <div style="font-size:small; padding: 0.5em;">
                        ...
                        <p> 🤝 И здесь нам нужна ваша помощь! Проект размещен в открытом <a styel="color: #FFA500;" href="https://github.com/vndv/querynomicon">Git-репозитории</a>, что позволяет каждому внести свой вклад в его развитие:
                            <ul>
                        ...
                        <p>
                            Текущая доступна по ссылке: <a styel="color: #FFA500;"href="https://querynomic.one/">Querynomic.One</a>
                        </p>
                    </div>
                </div>
            </div>
