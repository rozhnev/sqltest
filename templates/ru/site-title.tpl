<title>SQL задачи на SQLtest{if $Question && $Question.title} — ({$Question.title}){/if}</title>
<meta name="description" content="{if $Question && $Question.title} ({$Question.title}){/if}">
