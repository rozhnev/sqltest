<div class="welcome-container">
    ...
    <section>
        <h3>Assistance</h3>
        <p>Si vous avez besoin d'aide, si vous avez des remarques ou si vous voulez signaler un problème, envoyez-nous un e-mail à <a style="color: #8A5000; text-decoration: underline;" href="mailto:support@sqltest.online">support@sqltest.online</a>.</p>
    </section>
</div>
