<style>
            ...
            .banner-content::first-line {
                color: #63A9E4; /* Color for the first line only */
                font-weight: bold;
            }
            .viewchannel {
            ...
            <div class="banner-container">
                ...
                <div class="banner-content">
                    ...
                    <p style="font-weight: 100; margin: 5px 0 0 0;">
                        💡 Chaîne pour les développeurs de bases de données : Oracle, PostgreSQL<br>
                        📌 Tâches, code, meilleures pratiques, architecture, optimisation<br>
                        🔄 Rejoignez la communauté — grandissez avec nous !
                    </p>
                    {* <p>#SQL #Oracle #PostgreSQL #PL/SQL #PL/pgSQL #DB</p>
                    
                    <div class="viewchannel">VOIR LA CHAÎNE</div> *}
                </div>
            </div>
        </a>
