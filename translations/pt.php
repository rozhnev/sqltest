...
$translations = [
    ...
    'user_agreement_page_title' => 'SQLTest.online: Acordo de Publicação de Tarefas do Usuário',
    'user_agreement_page_description' => 'Este acordo rege seu envio de tarefas e exercícios SQL ao SQLTest. Ao enviar conteúdo, você nos concede uma licença para publicá-lo mantendo a propriedade. Todos os envios estão sujeitos a revisão e padrões de qualidade.',
    'email_verification_subject' => 'SQLTest.online - Código de Verificação de Email',
    'email_verification_greeting' => 'Olá!',
    'email_verification_body' => 'Seu código de verificação de email para SQLTest.online é:',
    'email_verification_expires' => 'Este código expira em 15 minutos.',
    'email_verification_footer' => 'Se você não solicitou este código, por favor ignore este email.',
    'email_verification_regards' => 'Atenciosamente,\nA equipe SQLTest.online',
    'profile_email_verification_label' => 'Verificação de email',
    'send_verification_code' => 'Enviar código de verificação',
    'verification_code_placeholder' => 'Código de 6 dígitos',
    'confirm_code' => 'Confirmar código',
    'verification_code_sent' => 'Código de verificação enviado',
    'email_verified' => 'Email verificado',
    'failed_send_verification_code' => 'Falha ao enviar o código de verificação',
    'failed_verify_email' => 'Falha ao verificar o email',
    ...
    'task_submissions' => 'Envio de tarefas',
    'loading_submission_requirements' => 'Carregando requisitos de envio...',
    'database_template' => 'Modelo de banco de dados',
    'title' => 'Título',
    'submission_task_description_plain' => 'Descrição da tarefa (texto simples)',
    'submission_hint_plain' => 'Dica (texto simples)',
    'submission_reference_solution_sql_query' => 'Consulta SQL de solução de referência',
    'submission_accept_i' => 'Aceito o',
    'submission_user_agreement' => 'acordo do usuário',
    'submission_and' => 'e',
    'submit' => 'Enviar',
    'cancel_edit' => 'Cancelar edição',
    'submission_requirements_satisfied' => 'Requisitos de envio: já atendidos (o primeiro envio já existe).',
    'submission_first_requirements' => 'Requisitos para o primeiro envio',
    'submission_not_set' => 'não definido',
    'submission_verified' => 'Verificado',
    'submission_yes' => 'sim',
    'submission_no' => 'não',
    'submission_agreement' => 'Acordo',
    'submission_accepted' => 'aceito',
    'submission_not_accepted' => 'não aceito',
    'failed_load_submission_requirements' => 'Falha ao carregar os requisitos de envio',
    'only_pending_submissions_editable' => 'Somente envios pendentes podem ser editados',
    'editing_submission' => 'Editando envio',
    'no_submissions_yet' => 'Ainda não há envios.',
    'moderation_note' => 'Nota de moderação',
    'approved_question_id' => 'ID da questão aprovada',
    'edit' => 'Editar',
    'delete' => 'Excluir',
    'submission' => 'Envio',
    'created' => 'Criado',
    'failed_load_submissions' => 'Falha ao carregar os envios',
    'submission_required_fields' => 'Título, tarefa, dica e consulta SQL são obrigatórios',
    'verify_email_before_first_submission' => 'Verifique seu email antes do primeiro envio',
    'accept_user_agreement_before_submission' => 'Aceite o acordo do usuário antes do envio',
    'failed_save_submission' => 'Falha ao salvar o envio',
    'submission_updated' => 'Envio atualizado',
    'submission_sent_for_review' => 'Envio enviado para revisão',
    'delete_pending_submission_confirm' => 'Excluir este envio pendente?',
    'failed_delete_submission' => 'Falha ao excluir o envio',
    'submission_deleted' => 'Envio excluído',
    'submission_status' => 'Status',
    'submission_status_pending' => 'Pendente',
    'submission_status_approved' => 'Aprovado',
    'submission_status_rejected' => 'Rejeitado',
    'actions' => 'Ações',
];