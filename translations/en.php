...
$translations = [
    ...
    'playground_content_title' => 'Practice SQL Online in a Real Playground',
    'playground_content_intro' => 'SQLTest.online Playground lets you write, run, and troubleshoot SQL directly in your browser. Switch between MariaDB, MySQL, PostgreSQL, SQLite, Microsoft SQL Server, Oracle, and Firebird to test syntax differences, validate ideas, and prepare for interviews, coursework, or real application work.',
    'playground_content_summary_title' => 'At a glance',
    'playground_content_summary_1' => 'Browser-based SQL editor with instant execution and immediate feedback.',
    'playground_content_summary_2' => 'Switch across seven SQL engines from one interface to compare behavior.',
    ...
    'playground_content_features_title' => 'Why use this SQL playground',
    'playground_content_feature_1' => 'Run SQL instantly without installing a database server on your machine.',
    'playground_content_feature_2' => 'Compare how common SQL statements behave across multiple database engines from one interface.',
    'playground_content_feature_3' => 'Prototype queries, debug errors, and learn SQL faster with immediate feedback.',
    ...
    'playground_content_faq_q2' => 'Can I compare SQL syntax across database engines?',
